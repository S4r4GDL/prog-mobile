...
class Category {
  ...
  int get hashCode =>
    ...
    (iexpense == null ? 0 : iexpense!.hashCode);

  @override
  String toString() => 'Category[id=$id, name=$name, user=$user, iexpense=$iexpense]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.iexpense != null) {
      json[r'iexpense'] = this.iexpense;
    } else {
      json[r'iexpense'] = null;
    }
    return json;
  }
  ...
  static Category? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Category(
        ...
        iexpense: mapValueOfType<bool>(json, r'iexpense'),
      );
    }
    return null;
  }
