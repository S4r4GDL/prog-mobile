...
// tests for PageNotificationPreferenceDTO
void main() {
  // final instance = PageNotificationPreferenceDTO();

  group('test PageNotificationPreferenceDTO', () {
    // int totalElements
    ...
    // List<NotificationPreferenceDTO> content (default value: const [])
